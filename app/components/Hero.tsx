      ...
      <section className="hero-section">
        ...
        <div className="hero-left">
          ...
          <div style={{ marginBottom: "1.75rem" }}>
            <h1
              className="hero-headline animate-fade-up stagger-2"
              style={{
                color: "#ffffff",
                opacity: 0,
              }}
            ...
            <h1
              className="hero-headline animate-fade-up stagger-3"
              style={{
                color: "#4a7a2a",
                opacity: 0,
              }}
            ...
            <h1
              className="hero-headline animate-fade-up stagger-4"
              style={{
                fontWeight: 300,
                color: "#2a2a28",
                opacity: 0,
          ...
          {/* Proof strip */}
          <div
            className="hero-proof-strip animate-fade-up stagger-7"
            style={{
        ...
        {/* Right Column */}
        <div
          className="hero-right animate-slide-right"
          style={{
            opacity: 0,
          }}
        >
